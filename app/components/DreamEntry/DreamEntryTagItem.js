...
import {
  View,
  StyleSheet, Text,
  Animated, TouchableWithoutFeedback, TextInput,
} from 'react-native';
...
class DreamEntryTagItem extends Component {
  ...
  render() {
    ...
    return (
      <View style={[{backgroundColor: color }, styles.TagItem]}>
        <TouchableWithoutFeedback
          editable={isEditable}
          onPress={() => this.props.onDelete(tag)}>
        ...
        <TextInput
          ...
          onChangeText={(text) => this.props.onEdit(text)}
